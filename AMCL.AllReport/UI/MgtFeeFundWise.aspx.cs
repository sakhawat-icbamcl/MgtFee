...
public partial class UI_MgtFeeFundWise : System.Web.UI.Page
{
    ...
    protected void ShowReportButton_Click(object sender, EventArgs e)
    {
        ...
        sb.Append("window.open('ReportViewer/mfFundWise.aspx?dateFrom=" + dateFrom + "&Todate=" + dateTo + "&FundCod=" + fundCode + "&FundName=" + fundName + "');");      
